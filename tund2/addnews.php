...
<div class ="container" style="max-width: 100%; margin-top:90px;">

	<section>
		<h1>Uudise lisamine</h1> <!--jumbotron on selleks, et täiendavat tähelepanu tõmmata (paneme teksti kasti sisse)-->
...
htmspecialchars funtsioon muudav spec muutujad (charasters) HTML sisenditeks. Kui kasutaja püüab PHP_SELF muutujat pahasti kasutada, ei lähe see tal läbi.-->
	<div class="container">		
		<label for="newTitle"><h2> Uudise pealkiri</h2></label>
			<br>
	
			<input type= "text" class ="form-control" name = "newsTitle" placeholder ="What's the news?" value="<?php echo $newsTitle; ?>">  
			<br>
	</div>
	<div class="container">
		<label for="newsEditor"><h2> Uudise sisu</h2></label>
			<br>
	
			<textarea class= "form-control" name="newsEditor" placeholder ="Tell me something interesting... Amuse me. " rows="6" cols="40"><?php echo $newsContent;?></textarea>
			<br>

		<input type="submit" class="btn btn-default" name="newsBtn" Value="Salvesta uudis! ">
