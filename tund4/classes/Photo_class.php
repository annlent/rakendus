<?php
	class Photo {
		...
		private $myTempImage; //originaalsuurus
		...
		public function resizePhoto($w, $h, $keepOrigProportion = true){  //public - kui tahad, et omadus/meetod oleks rakenduatud igal pool, st kõikides klassides ja objektides
